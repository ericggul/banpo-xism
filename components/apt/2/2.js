...
export default function AptComplex13() {
  ...
  const unitSpreadControls = useControls('Unit Spread', {
    unitSpreadX: { value: 0, min: -4, max: 8, step: 0.1, label: 'Spread X (m)' },
    unitSpreadY: { value: 0, min: -2, max: 2, step: 0.05, label: 'Spread Y (m)' },
    unitSpreadZ: { value: 0, min: -4, max: 8, step: 0.1, label: 'Spread Z (m)' },
  });

  const unitAngleControls = useControls('Unit Angle', {
  ...
  const dongRotationControls = useControls('Dong Rotation', {
    dongRotationX: { value: 0, min: -45, max: 45, step: 1, label: 'Rotate X (°)' },
    dongRotationY: { value: 0, min: -90, max: 90, step: 1, label: 'Rotate Y (°)' },
    dongRotationZ: { value: 0, min: -45, max: 45, step: 1, label: 'Rotate Z (°)' },
  });
