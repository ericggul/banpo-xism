...
const LIVING_ROOM_WIDTH = 4.71;
const INNER_BEDROOM_WIDTH = 3.21;
const UNIT_OFFSET_X = LIVING_ROOM_WIDTH / 2 + INNER_BEDROOM_WIDTH; // Align inner bedrooms
const BACK_CORRIDOR_OFFSET_Z = CORE_HALF_DEPTH + CONNECTOR_LENGTH; // corridor sits behind units
const CONNECTOR_BRANCH_OFFSET_X = CONNECTOR_WIDTH / 2 + CONNECTOR_LENGTH_GEOM / 2;

const STRUCTURE_HALF_WIDTH = UNIT_OFFSET_X + UNIT_HALF_WIDTH;
const STRUCTURE_HALF_DEPTH = Math.max(UNIT_HALF_DEPTH, BACK_CORRIDOR_OFFSET_Z);

const DONG_WIDTH = STRUCTURE_HALF_WIDTH * 2;
const DONG_DEPTH = STRUCTURE_HALF_DEPTH * 2;

const UNIT_LAYOUT = [
  { key: 'left', rotation: 0, position: [-UNIT_OFFSET_X, 0, 0] },
  { key: 'right', rotation: 0, position: [UNIT_OFFSET_X, 0, 0] },
];
...
const CONNECTOR_LAYOUT = [
  {
    key: 'left-wing',
    type: 'x',
    position: [-CONNECTOR_BRANCH_OFFSET_X, 0, BACK_CORRIDOR_OFFSET_Z],
  },
  {
    key: 'right-wing',
    type: 'x',
